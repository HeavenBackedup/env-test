  ...
  [  '$stateProvider', '$urlRouterProvider', '$controllerProvider', '$compileProvider', '$filterProvider', '$provide',
    function ($stateProvider,   $urlRouterProvider,   $controllerProvider,   $compileProvider,   $filterProvider,   $provide) {
        ...
        $stateProvider
            ...
            // 表单+切换卡
            .state('app.formSubmit', {
                url: '/formSubmit',
                templateUrl: 'tpl/formSubmit.html'
            })
            // 查询+弹窗
            ...
            // 特殊切换卡
            .state('app.tabSpecail', {
                url: '/tabSpecail',
                templateUrl: 'tpl/tabSpecail.html'
            })
            ...
            .state('access.login', {
                url: '/login',
                templateUrl: 'tpl/dev/signin_model.html',
